 ...
 */
export type ColumnType = "string"|"boolean"|"integer"|"float"|"partialdate"|"date"|"datetime"|"select:string"|"select:integer"|"array:string"|"time"|"object"|"hidden"|"combi:string";
